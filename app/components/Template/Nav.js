...
const Nav = () => (
  <section id="sidebar">
    <section id="intro">
      ...
      <header>
        <h2>Omar El Tarzi</h2>
        <p><a href="mailto:omartarzi@gmail.com">omartarzi@gmail.com</a></p>
      </header>
    </section>

    <section className="blurb">
      <h2>About</h2>
      <p>Hi, I&apos;m Omar. I like building things.
    ...
    <section id="footer">
      ...
      {/* <p className="copyright">&copy; Omar El Tarzi <Link to="/">gmail.com</Link>.</p> */}
    </section>
  </section>
);
